...
Personal finance dashboard — track income, manage expenses, visualize your money flow.
...
│   └── Navbar.module.css
├── pages/
│   ├── Dashboard.jsx       # Homepage (matches design)
│   ├── Transactions.jsx    # Add / delete / filter expenses
│   ├── Budget.jsx          # Per-category monthly limits
│   ├── Income.jsx          # Set monthly income
│   └── Settings.jsx        # Export + about
├── utils/
│   └── helpers.js          # fmt, exportCSV, greeting
├── App.jsx                 # Router
...
- Add / delete expenses with category, date, note
- 7 built-in categories with color coding
- Monthly budget limits per category with progress bars
- Income tracking → savings rate calculation
- Dashboard: balance, metrics, recent transactions
