...
import MoneyFlowPage from "./pages/MoneyFlow/MoneyFlowPage";
...
const router = createHashRouter(
  createRoutesFromElements(
    <>
      {/* Home page — full-screen layout, no sidebar */}
      <Route path="/" element={<HomePage />} handle={{ title: "Home" }} />

      {/* All other pages — sidebar layout via AppLayout */}
      <Route element={<App />}>
        <Route path="dashboard" element={<DashboardPage />} handle={{ title: "Dashboard" }} />
        <Route path="money-flow" element={<MoneyFlowPage />} handle={{ title: "Money Flow" }} />
